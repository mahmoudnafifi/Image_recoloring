...
int main()
{
	...
	feature_t   f1[4] = { {100,40,22}, {211,20,2}, {32,190,150}, {2,100,100} },
		f2[4] = { {0,4,0}, {50,100,80}, {255,255,255},{ 255,255,255 } }, f3[4] = { {0,10,0}, {20,100,80}, {25,255,255}, {2,1,10} };
	float       w1[4] = { 0.4, 0.3, 0.2, 0.1 },
		w2[4] = { 0.5, 0.3, 0.2, 0.3 }, w3[4] = { 0.1,0.2,0.5,0.2 };
	...
	float*  e;
	const int size = 3;
	signature_t* S1[size] = { &s1,&s2,&s3 };


	//test emd2
	//e = emd2(&s1, S1, size, 0, 0);
	//for (int i = 0; i < size; i++)
	//	printf("emd=%f\n", e[i]);
